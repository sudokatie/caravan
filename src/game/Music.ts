/**
 * Music system for Caravan using Web Audio API.
 * Generates frontier/western journey-themed chiptune background music.
 */
...
class MusicSystem {
  ...
  private playNote(freq: number, startTime: number, duration: number, vol: number = 1): void {
    ...
    // Triangle wave for folksy, warm feel
    osc.type = 'triangle';
  ...
  // Gameplay track - frontier journey, western trail
  ...
  // Menu track - anticipation of the journey
  ...
  // Victory track - successful arrival
  ...
  // Game over track - lost on the trail
